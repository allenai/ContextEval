...
python3 main/generate_analysis_responses.py --context_name "${CONTEXT_NAMES[$CONTEXT_INDEX]}" --default=False

echo "Generating evals for context: ${CONTEXT_NAMES[$CONTEXT_INDEX]}"
python3 main/generate_analysis_evals.py --context_name "${CONTEXT_NAMES[$CONTEXT_INDEX]}" --default=False
